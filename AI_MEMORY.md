...
- **Dernière mise à jour de ce fichier :** 2026-04-22.
...
- **Composants UI :** 
  ...
  - Composants enfants :
    ...
    - `ListeTypesActivite.tsx` : **Types d’activité** du séjour — accordéons **par défaut** vs **personnalisés**, CRUD (`SaveTypeActiviteRequest`), **`useRevalidator`** après succès, styles **`listPredefinis`**, **`cardReadonly`**, modale suppression avec gestion **type encore utilisé** (voir *Dernière réalisation*).
