...
4. **[etat-projet.md](etat-projet.md)** — Alignement contrat enjoyApi, inventaire des services API, glossaire détaillé (loader, domaine).
5. **[documentation-ui-routing.md](documentation-ui-routing.md)** — Routes, navigation, layout, gardes d’accès.
6. **[roadmap.md](roadmap.md)** — Tâches faites / à faire côté front.
