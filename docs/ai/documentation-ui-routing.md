...
- Routes principales :
  ...
  - `/mes-sejours/:id/parametrage` : Même loader parent ; **Paramétrage** (`DetailsSejourParametrage` : Lieux, Moments, Horaires, Types d’activité, **Références alimentaires**, **Affichage des menus** — préférences locales pour l’onglet Menus)
